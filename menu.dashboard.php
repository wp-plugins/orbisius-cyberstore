...
<div class="webweb_wp_plugin">
    <div class="wrap">
        ...
        <p>Please check the <a href="<?php echo $orbisius_digishop_obj->get('plugin_admin_url_prefix');?>/menu.support.php">Help</a> section if you need instructions how to use this plugin.</p>

        <table class="app_table">
            <tr>
                <td>Plugin Status</td>
                <td><?php echo empty($opts['status']) ? $orbisius_digishop_obj->msg('Disabled') : $orbisius_digishop_obj->msg('Enabled', 1);?></td>
            </tr>            
        </table>
		...
		<?php
		$app_link = $orbisius_digishop_obj->get('plugin_home_page');
		...
		<h3>Comment</h3>
        <p>Please use this comment box to share how cool Orbisius_CyberStore is but for support requests please use our forums. Thanks.</p>
